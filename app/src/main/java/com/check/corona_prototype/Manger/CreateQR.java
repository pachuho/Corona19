...
import com.check.corona_prototype.GpsTracker;
...
//        Toast.makeText(CreateQR.this, text, Toast.LENGTH_LONG).show();
    ...
    void checkRunTimePermission(){
        ...
        int hasFineLocationPermission = ContextCompat.checkSelfPermission(CreateQR.this,
                Manifest.permission.ACCESS_FINE_LOCATION);
        int hasCoarseLocationPermission = ContextCompat.checkSelfPermission(CreateQR.this,
        ...
        if (hasFineLocationPermission == PackageManager.PERMISSION_GRANTED &&
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(CreateQR.this, REQUIRED_PERMISSIONS[0])) {

                // 3-2. 요청을 진행하기 전에 사용자가에게 퍼미션이 필요한 이유를 설명해줄 필요가 있습니다.
                Toast.makeText(CreateQR.this, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.", Toast.LENGTH_LONG).show();
                // 3-3. 사용자게에 퍼미션 요청을 합니다. 요청 결과는 onRequestPermissionResult에서 수신됩니다.
                ActivityCompat.requestPermissions(CreateQR.this, REQUIRED_PERMISSIONS,
